...
#[derive(Clone, Copy)]
struct CollectionItemSpec {
    unlock_id: &'static str,
    item_id: &'static str,
    ...
    pub fn record_typing(
        ...
        if unlocked
            || self
                .data
                .typing_events
                .is_multiple_of(TYPING_FLUSH_INTERVAL)
        {
            self.save()?;
        }
            ...
            items: vec![
                item(
                    CollectionItemSpec {
                        unlock_id: NIGHT_CAP,
                        item_id: "night_cap",
                        kind: CollectionItemKind::Cosmetic,
                        title: "Night Cap",
                        description: "A sleepy headwear extra for spending time with Byte.",
                        condition: "Keep Byte around for one week.",
                    },
                ...
                item(
                    CollectionItemSpec {
                        unlock_id: MEMORY_FRAME,
                        item_id: "memory_frame",
                        kind: CollectionItemKind::Decoration,
                        title: "Memory Frame",
                        description: "A small anniversary keepsake for habitat backgrounds.",
                        condition: "One month since Byte first joined you.",
                    },
                ...
                item(
                    CollectionItemSpec {
                        unlock_id: AURORA,
                        item_id: "aurora",
                        kind: CollectionItemKind::Palette,
                        title: "Aurora Palette",
                        description: "An extra colorway available across all four companions.",
                        condition: "A longer natural typing milestone.",
                    },
                ...
                item(
                    CollectionItemSpec {
                        unlock_id: CHARGING_ORB,
                        item_id: "charging_orb",
                        kind: CollectionItemKind::Decoration,
                        title: "Charging Orb",
                        description: "A tiny glowing prop unlocked by ordinary charging sessions.",
                        condition: "Let Byte notice a few normal charging sessions.",
                    },
                ...
                item(
                    CollectionItemSpec {
                        unlock_id: RARE_A,
                        item_id: "rare_a",
                        kind: CollectionItemKind::Idle,
                        title: "Rare Idle I",
                        description: "Replay a rare animation after Byte performs it naturally.",
                        condition: "Notice this rare idle in the desktop companion.",
                    },
...
fn item(
    ...
    CollectionItemProgress {
        unlock_id: spec.unlock_id.into(),
        item_id: spec.item_id.into(),
        kind: spec.kind,
        title: spec.title.into(),
        description: spec.description.into(),
        condition: spec.condition.into(),
        unlocked,
        progress_current,
        progress_target,
    }
