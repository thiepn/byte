...
<div class="studio">
  <aside class="preview-column">
    ...
    <CustomizationPreview preferences={draft} />
    ...
    <div class="editor-surface">
      {#if activeSection === "LOOKS"}
        ...
        <div class="catalog-note">
          ...
          <small>Phase 18 exposes the complete built-in collection. Progression/unlocks remain a separate Phase 19 system.</small>
        </div>
        ...
        <div class="subsection">
          ...
          <div class="palette-grid">
            {#each palettes as palette}
              <button type="button" class:selected={draft.palette === palette.id} onclick={() => choosePalette(palette.id)}>
          ...
          <div class="subsection">
            ...
            <div class="asset-grid">
              ...
              {#each cosmeticOptions(category) as item}
                <button type="button" class:selected={draft.customization[category] === item.id} onclick={() => chooseCosmetic(category, item.id)}>
                  <span class="asset-preview"><img src={item.src} alt="" /></span>
                  <strong>{item.name}</strong>
                  <small>Fits all characters</small>
                </button>
              {/each}
            </div>
          </div>
          ...
          <div class="subsection">
            ...
            <div class="asset-grid compact-assets">
              ...
              {#each decorationOptions(slot) as item}
                <button type="button" class:selected={draft.customization.decorations[slot] === item.id} onclick={() => chooseDecoration(slot, item.id)}>
